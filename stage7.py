...
import numpy as np
import itertools
from extensions.ebsynth_kit.stage6 import create_movie_from_frames, get_ext, trying_to_add_audio
...
def ebsynth_utility_stage7(dbg, project_args, bg_src, bg_type, mask_blur_size, mask_threshold, fg_transparency, export_type):
    dbg.print("stage7")
    dbg.print("")

    if not bg_src:
        dbg.print("Fill [configuration] -> [stage 7] -> [Background source]")
        return
